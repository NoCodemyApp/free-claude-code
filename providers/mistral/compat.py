"""Mistral La Plateforme request and stream compatibility helpers."""
...
_REASONING_ERROR_TERMS = frozenset(
    {
        "reasoning",
        "reasoning_content",
        "reasoning_effort",
...
def is_mistral_reasoning_rejection(error: Exception) -> bool:
    ...
    return any(term in lowered for term in _REASONING_ERROR_TERMS)
